...
# in python non ci sono dichiarazioni
...
#facciamo una print con f-string
print(f"Hai inserito {a} che è di tipo {type(a)}") #la f ti permette di mettere in automatico le variabili dentro le print
